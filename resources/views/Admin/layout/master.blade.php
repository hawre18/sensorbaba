...
<div class="wrapper">
                        ...
                        <ul class="dropdown-menu">
                            <li class="user-header">
                                <p>
                                    ...
                                    <span class="center-block text-center"></span>
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href=""><i class="fa fa-circle-o"></i>لیست برندها</a></li>
                    </ul>
                </li>
                <li class="treeview">
                    <a href="#">
                    ...
                    <ul class="treeview-menu">
                        <li><a href=""><i class="fa fa-circle-o"></i>لیست کوپن ها</a></li>
                    </ul>
                </li>
                <li class="treeview">
                    <a href="#">
                    ...
                    <ul class="treeview-menu">
                        <li><a href=""><i class="fa fa-circle-o"></i>لیست اسلایدها</a></li>
                    </ul>
                </li>
                <li class="treeview">
                    <a href="#">
                    ...
                    <ul class="treeview-menu">
                        <li><a href=""><i class="fa fa-circle-o"></i>لیست سفارشات</a></li>
                    </ul>
                </li>
                <li class="treeview">
                    <a href="#">
                    ...
                    <ul class="treeview-menu">
                        <li><a href=""><i class="fa fa-circle-o"></i>لیست کامنت ها</a></li>
                    </ul>
                </li>
                <li class="treeview">
                    <a href="#">
                    ...
                    <ul class="treeview-menu">
                        <li><a href=""><i class="fa fa-circle-o"></i>لیست استان ها</a></li>
                    </ul>
                </li>
                <li class="treeview">
                    <a href="#">
                    ...
                    <ul class="treeview-menu">
                        <li><a href=""><i class="fa fa-circle-o"></i>لیست شهر ها</a></li>
                    </ul>
                </li>
            </ul>
        </section>
    ...
    <footer class="main-footer">
        <strong>&copy;<a href="">ساکا مارکت</a>.</strong> حق کپی رایت محفوظ است
    </footer>
